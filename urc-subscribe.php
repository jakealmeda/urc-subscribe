	...
	if( in_array( $targ_file, apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ){ 
		...
		if( $mobile_d_file ) {
			...
			if( $detect->isTablet()	|| !$detect->isMobile() ) {
				...
				// in-line JS in the footer
//				add_action( 'wp_footer', 'setup_subscribe_js_footer' );
			} else {
	...
	$cta_ebook_expanded = '<div class="module cta-main"><div class="module-wrap">
...
*/
	...
	// CTA | Free eBook Compressed
	$cta_ebook_compressed = '<div class="module cta-icon"><div class="module-wrap">
